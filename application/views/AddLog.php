						...
						<!-- <form method="post" name="FrmLogDetails" id="FrmLogDetails"> -->
							...
							<div class="form-group">
								<div class="form-line">
									...
									<input type="text" id="project"  name="project"  class="form-control" placeholder="Enter Project Name" >
								...
								<div class="form-group">
									<div class="form-line">
										<input type="text" id="dailylog"  name="dailylog" class="form-control" placeholder="Enter Log Details" >
